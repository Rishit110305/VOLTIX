...
const Pricing = () => {
  ...
  return (
    <section id="pricing" className={"container mx-auto my-20 md:my-28"}>
      <div className="flex flex-col items-center  gap-4 text-center container mx-auto">
        ...
        <div className="not-prose mt-8 grid grid-cols-1 gap-6 min-[850px]:grid-cols-3 justify-center justify-items-center mx-auto max-w-6xl">
