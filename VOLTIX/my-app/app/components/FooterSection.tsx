...
export default function FooterSection() {
  return (
    <footer className="border-ali/20 :px-4 mx-auto w-full border-b   border-t  px-2 mt-16 md:mt-24">
      <div className="relative mx-auto grid  max-w-7xl items-center justify-center gap-6 p-10 pb-0 md:flex ">
        ...
        <p className="bg-transparent text-center text-xs leading-4 text-black dark:text-white md:text-left">
          ...
          an agency of one. This means you will work directly with me, founder of
          Designali.
        </p>
      </div>
                  ...
                  >
                    {section.items.map((item) => (
                      <li key={item.name} className="flow-root">
                        <Link
                          href={item.href}
                          className="text-sm text-black hover:text-black dark:text-white hover:dark:text-white md:text-xs"
                        >
                          {item.name}
                        </Link>
                      </li>
      ...
      <div className="mx-auto mb-10 mt-10 flex flex-col justify-between text-center text-xs md:max-w-7xl">
        <div className="flex flex-row items-center justify-center gap-1 text-black dark:text-white">
          <span> © </span>
          ...
          -
          <span className="hover:text-ali dark:hover:text-red-600 cursor-pointer text-black dark:text-white">
