...
const ParticleCard: React.FC<{
  ...
  const clearAllParticles = useCallback(() => {
    // Fix: Cast timeout to any to avoid TS2345 error
    timeoutsRef.current.forEach((timeout) => clearTimeout(timeout as any));
    timeoutsRef.current = [];
  ...
  const animateParticles = useCallback(() => {
    ...
    memoizedParticles.current.forEach((particle, index) => {
      ...
      // Fix: Cast timeoutId to number for type compatibility
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-3 p-4 max-w-[70rem] select-none relative"
      ...
      <style>
        {`
          ...
          .card__label {
            ...
            text-shadow: 0 0 8px rgba(16, 185, 129, 0.5), 0 0 16px rgba(16, 185, 129, 0.35);
          }
          ...
          .card--border-glow:hover {
            box-shadow: 0 8px 28px rgba(16, 185, 129, 0.18), 0 0 36px rgba(${glowColor}, 0.28);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 6px 24px rgba(16, 185, 129, 0.15), 0 0 30px rgba(${glowColor}, 0.25);
          }
